...
import cv from '../../assets/img/HVIvanMuñoz2024-2.pdf'
        ...
        <div >
            <div className="container-fluid bg-primary">
                <div className="container text-center text-white">
                    <p className='fs-6 pt-5 mb-0' id='inicio'><small>Hola</small> </p>
            ...
            <div className="container">
                <h1 className='text-center' id='trabajos'>Trabajos</h1>
                <div class="row my-5">
